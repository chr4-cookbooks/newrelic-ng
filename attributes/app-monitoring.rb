...
default['newrelic-ng']['app_monitoring']['daemon']['config_file'] = "#{node['newrelic-ng']['config_path']}/newrelic.cfg"
default['newrelic-ng']['app_monitoring']['daemon']['upgrade_file'] = "#{node['newrelic-ng']['config_path']}/upgrade_please.key"
